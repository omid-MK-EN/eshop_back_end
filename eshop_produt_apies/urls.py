...
router.register('products',  EshopProductPaginationViewSet,basename="products")
router.register('products-without-pagination',  EshopProductViewSet,basename="products-without-pagintion")
